...
<task type="auto">
  ...
  <action>
    ...
    2. Move essential Linux files using git mv:
       ...
       - Move relevant install scripts from platforms/linux/install/

    3. For each moved file, update source statements:
    ...
    4. Remove any symlinks that were pointing to old locations.
       Check platforms/linux/utils/ for symlinks.

    5. Evaluate duplicate files between scripts/utils/ and platforms/linux/utils/:
