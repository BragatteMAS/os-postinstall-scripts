...
[![Version: 5.6.1](https://img.shields.io/badge/Version-5.6.1-orange?style=flat)](CHANGELOG.md)
...
[`docs/troubleshooting.md`](docs/troubleshooting.md). Full pitfalls list:
...
| Old machine → new machine | [`docs/migration-guide.md`](docs/migration-guide.md) |
| Shell history sync — atuin (optional) | [`docs/atuin.md`](docs/atuin.md) |
| Troubleshooting + recovery cookbook | [`docs/troubleshooting.md`](docs/troubleshooting.md) |
| 47 cataloged pitfalls | [`docs/PITFALLS.md`](docs/PITFALLS.md) |
...
- Built with [Claude Code](https://claude.ai/) as co-pilot (580+ commits)
